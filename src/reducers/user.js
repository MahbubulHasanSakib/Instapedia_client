...
const getAllUsersReducer = (state = {users:[],tempUsers:[]}, action) => {
    switch (action.type) {
...
const friendProfileReducer = (state = { friendProfileDetails: {},followUnfollowSuccess:true,loading:false}, action) => {
    switch (action.type) {
...
const getFollowersReducer = (state = { followers:[],loading:false}, action) => {
    switch (action.type) {
...
const getFollowingsReducer = (state = { followings:[],loading:false}, action) => {
    switch (action.type) {
